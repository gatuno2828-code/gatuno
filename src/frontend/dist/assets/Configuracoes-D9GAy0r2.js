import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as cn, o, v as vt, L as Layout, S as Skeleton, D as DollarSign, C as Car, f as formatCurrency } from "./index-Cnf9ohm-.js";
import { P as Primitive, B as Button, S as Separator } from "./separator-BikIZFIf.js";
import { I as Input } from "./input-DPYUSPlB.js";
import { S as Switch } from "./switch-DWj7YEhf.js";
import { e as useSettings, f as useUpdateSettings } from "./useBackend-BZl6GTZ-.js";
...
const SlidersVertical = createLucideIcon("sliders-vertical", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function SectionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-6 space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-foreground text-base", children: title })
    ] }),
...
function ToggleRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 py-2", children: [
...
function Configuracoes() {
  ...
  const [priceForm, setPriceForm] = reactExports.useState(null);
  const [rideForm, setRideForm] = reactExports.useState(null);
  const [featForm, setFeatForm] = reactExports.useState(null);
  const [previewKm, setPreviewKm] = reactExports.useState(10);
  const [previewMin, setPreviewMin] = reactExports.useState(20);
  const current = settings ? { ...settings, ...priceForm, ...rideForm, ...featForm } : void 0;
  const handleSavePrice = () => {
    if (!current) return;
    updateSettings.mutate(current, {
      onSuccess: () => {
        ue.success("Configurações salvas com sucesso!", {
          duration: 3e3,
          className: "bg-primary text-primary-foreground"
        });
        setPriceForm(null);
      },
      onError: () => ue.error("Erro ao salvar configurações.")
    });
  };
  const handleSaveFeat = () => {
    ...
    updateSettings.mutate(current, {
      ...
      onError: () => ue.error("Erro ao salvar funcionalidades.")
    });
  };
  const liveBase = (current == null ? void 0 : current.baseFare) ?? 5;
  const liveKm = (current == null ? void 0 : current.perKmRate) ?? 2.5;
  const liveMin = (current == null ? void 0 : current.perMinuteRate) ?? 0.5;
  const liveMinFare = (current == null ? void 0 : current.minFare) ?? 7;
  ...
  if (isLoading || !current) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", "data-ocid": "configuracoes.page", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Configurações" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Parâmetros de tarifas e configurações gerais da plataforma" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl space-y-4", children: ["s1", "s2", "s3", "s4"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full rounded-xl" }, k)) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", "data-ocid": "configuracoes.page", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Settings2, { size: 20, className: "text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Configurações" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm ml-7", children: "Parâmetros de tarifas e configurações gerais da plataforma" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 18 }), title: "Preços e Tarifas", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setPriceForm((f) => ({ ...f ?? current, baseFare: v2 }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setPriceForm((f) => ({ ...f ?? current, perKmRate: v2 }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setPriceForm((f) => ({ ...f ?? current, perMinuteRate: v2 }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setPriceForm((f) => ({
                ...f ?? current,
                serviceFeePercent: v2
              }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setPriceForm((f) => ({ ...f ?? current, minFare: v2 }))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              ...
              updateSettings.isPending ? "Salvando..." : "Salvar Configurações de Preço"
            ]
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { size: 18 }), title: "Configurações de Corrida", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setRideForm((f) => ({ ...f ?? current, searchRadiusKm: v2 }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setRideForm((f) => ({
                ...f ?? current,
                acceptanceTimeoutSec: v2
              }))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            NumField,
            {
              ...
              onChange: (v2) => setRideForm((f) => ({
                ...f ?? current,
                cancellationFeePercent: v2
              }))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 p-4 rounded-lg bg-muted/30 border border-border flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Quando ativado, o app fica indisponível para novos pedidos." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Switch,
            {
              checked: current.maintenanceMode,
              onCheckedChange: (checked) => setRideForm((f) => ({
                ...f ?? current,
          ...
          Button,
          {
            onClick: () => {
              ...
              updateSettings.mutate(current, {
                ...
                onError: () => ue.error("Erro ao salvar.")
              });
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SlidersVertical, { size: 18 }), title: "Funcionalidades", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 divide-y divide-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleRow,
            {
              ...
              onCheckedChange: (v2) => setFeatForm((f) => ({ ...f ?? current, scheduledRide: v2 })),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleRow,
            {
              ...
              onCheckedChange: (v2) => setFeatForm((f) => ({ ...f ?? current, shareRoute: v2 })),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ToggleRow,
            {
              ...
              onCheckedChange: (v2) => setFeatForm((f) => ({
                ...f ?? current,
                multipleDestinations: v2
              })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { size: 15 }),
              updateSettings.isPending ? "Salvando..." : "Salvar Funcionalidades"
            ]
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { size: 18 }), title: "Preview do Cálculo", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground -mt-1", children: "Simulador ao vivo — ajuste km e minutos para ver o valor estimado em tempo real." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                step: 1,
                value: previewKm,
                onChange: (e) => setPreviewKm(Number.parseFloat(e.target.value) || 0),
                className: "bg-background border-border",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                step: 1,
                value: previewMin,
                onChange: (e) => setPreviewMin(Number.parseFloat(e.target.value) || 0),
                className: "bg-background border-border",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-primary/10 border border-primary/30 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-mono", children: [
              ...
              " ",
              "→ mín. ",
              formatCurrency(liveMinFare)
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: "Valor estimado" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-3xl font-bold text-primary",
                "data-ocid": "configuracoes.preview_fare",
                children: formatCurrency(previewFare)
              }
            )
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground text-center pb-4 flex items-center justify-center gap-1.5", children: [
